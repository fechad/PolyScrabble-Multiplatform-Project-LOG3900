...
export const santaEnglishQuotes: Quotes = {
    greeting: 'Welcome to the Scrabble festivities, my friend! May the letters be ever in your favor! 🎅',
    bigScore: 'Ho ho ho! That was a festive word indeed! Keep up the holiday cheer! 🎉',
    extremeScore:
...
export const santaFrenchQuotes: Quotes = {
    greeting: 'Bienvenue aux festivités de Scrabble, mon ami ! Que les lettres soient toujours en votre faveur ! 🎅',
    bigScore: "Ho ho ho ! C'est un mot de Noël extraordinaire ! Continuez à faire vivre l'esprit des fêtes ! 🎉",
    extremeScore:
