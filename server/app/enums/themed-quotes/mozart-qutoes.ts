...
export const mozartEnglishQuotes: Quotes = {
    ...
    specialAnnouncement: `It's obvious to play the word ${PLACEHOLDER_NEW_WORD_PLACED} when the letters "${PLACEHOLDER_LETTERS_ALREADY_PLACED}" are already in place. Thank you for doing most of the work for me! 🎹`,
};
