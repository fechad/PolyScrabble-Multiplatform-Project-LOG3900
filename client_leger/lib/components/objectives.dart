...
class ObjectivesState extends State<Objectives> {
  ...
  _configure() {
    ...
    socketService.on('goalsUpdated', (receivedGoals) => {
        ...
        setState(() {
          socketService.on('goalsUpdated', (receivedGoals) => {
            ...
            for (Map<String, dynamic> goal in receivedGoals) {
              ...
              gameService.goals.add(Goal(title: res['title'],
                            ...
                            GestureDetector(
                              onTap: () {
                                showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        title: Text(gameService.goals[index].title),
                                        content:
                                        Container(
                                        width: 300,
                                        height: 60,
                                        child: Text(gameService.goals[index].description),
                                      ));
                                    });
                          },
                        child: gameService.goals[index].reached ? Container(
                                ...
                                child: Row(
                                    children: [
                                      Container(
                                          ...
                                          child:Text(gameService.goals[index].title,
                                      ...
                                      Container(
                                          ...
                                          child:Text(gameService.goals[index].reward > 0 ? '+${gameService.goals[index].reward}':'x2',
                                            style: GoogleFonts.nunito(
                                              textStyle: TextStyle(
                                                  fontSize: 20,
