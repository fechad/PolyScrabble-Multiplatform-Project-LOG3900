...
import { SocketClientBotService } from './socket-client-bot.service';

describe('SocketClientBotService', () => {
    let service: SocketClientBotService;

    beforeEach(() => {
        TestBed.configureTestingModule({});
        service = TestBed.inject(SocketClientBotService);
    ...
    it('should change the socket value on connect', () => {
        const oldSocket = service.socket;
        service.connect();
        expect(service.socket).not.toEqual(oldSocket);
    });
    ...
    it('should call socket.on with an event', () => {
        ...
        // disable because we don't need and implementation for this function
